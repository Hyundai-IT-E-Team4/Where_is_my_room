	...
	<header class="page-header">
		...
		<div class="header-menu">
			<nav class="header-navigation">
				<a href="${contextPath}/map"><b>지도</b></a> <a
					href="${contextPath}/boards/enroll"><b>방 내놓기</b></a> <a
					href="${contextPath}/messages"><b>메시지</b></a>
			</nav>
				...
				<form class="register-form" method="post" action="update"
					...
					<div class="input">
						...
						<div class="profile-img">
							<img width="130" height="130" id="preview-image"
								alt="profile-img" src="${sessionScope.userInfo.profile_img}">
						</div>
						<input style="cursor: pointer; display: none;" class="input-info"
							id="uploadProfileImg" type="file" name="uploadProfileImg"
							placeholder="파일 등록" accept=".jpg, .png"
					...
					<div class="input">
						...
						<input type="hidden" name="email"
							value="${sessionScope.userInfo.email}"> <input
							class="input-info" id="name" type="text" name="name"
							maxlength="20" placeholder="이름" required="required"
							value="${sessionScope.userInfo.name}">
					</div>
					<div class="input">
						<div class="label">
						...
						<div class="inputs">
							<input class="input-info" id="nickname" type="text"
								name="nickname" maxlength="20" required="required"
								placeholder="닉네임" value="${sessionScope.userInfo.nickname}">
					...
					<div class="input">
						...
						<input class="input-info" type="password" name="password"
							maxlength="20" placeholder="계정 비밀번호" autocomplete="off">
					</div>
